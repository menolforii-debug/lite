...
<head>
    ...
    <link rel="stylesheet" href="<?= Config::baseUrl('/vendor/sow/css/sow.vendor.min.css') ?>">
    <link rel="stylesheet" href="<?= Config::baseUrl('/vendor/sow/css/sow.core.min.css') ?>">
...
<script src="<?= Config::baseUrl('/vendor/sow/js/sow.vendor.min.js') ?>"></script>
<script src="<?= Config::baseUrl('/vendor/sow/js/sow.core.min.js') ?>"></script>
